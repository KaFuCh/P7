...
\FXRegisterAuthor{f}{aka}{fuglsang}
\FXRegisterAuthor{r}{ata}{Rasmus}
\FXRegisterAuthor{k}{aal}{Helsted}
\FXRegisterAuthor{z}{ach}{Zobair}
...
\setcounter{secnumdepth}{3} % make paragraphs have numbering as well
\setcounter{tocdepth}{3}

\fancypagestyle{BasicStyle}{
	\fancyhead[OL, ER]{
		\parbox{17mm}{{\includegraphics[scale=0.25]{aau_logo_cropped.png}}}\parbox{45mm}{\textsc{Aalborg University}\\\textit{sw610f16}}}
